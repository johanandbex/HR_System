...
namespace HR_System.Web
{
    public class RegionsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "RegionId,RegionName")] Region region)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "RegionId,RegionName")] Region region)
        {
            if (ModelState.IsValid)
            {
