...
namespace HR_System.Web
{
    public class StatusController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "StatusId,Status1")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "StatusId,Status1")] Status status)
        {
            if (ModelState.IsValid)
            {
